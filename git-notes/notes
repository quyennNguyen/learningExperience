...
*git add <file's name>: to track changes/updates/deletes of your files in Git
...
*git push origin master: to upload Git commits from your local machine to the remote repo where your project is hosted
    you can use git push -u origin master to set an upstream for the origin master to set it as a default so that everytime you want to use git push origin master, you can use git push without typing out origin master
...
*git branch: to list all branches in the repo
    you can hit Q to get out of the branch list
